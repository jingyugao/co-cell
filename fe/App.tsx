...
export default function App() {
  ...
  const { projects, refreshProjects, createProject, updateProject, rebuildSandbox, backupProject, archiveProject } = useProjects();
