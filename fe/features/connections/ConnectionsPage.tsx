...
export default function ConnectionsPage({ onMenu, onBack }: Props) {
  ...
  return <main className="main-pane connections-page">
    ...
    <div className="connections-scroll">
      ...
      <div className="connections-notice"><span aria-hidden="true">↗</span><p>沙箱支持 <code>glab</code>、<code>mysql</code>、<code>git</code>、<code>lark-cli</code>、<code>meegle</code> 和 <code>kubectl</code>。工具与凭据分别准备，凭据单独同步到 Sandbox，不写入 Docker 镜像。正在执行的任务不会被打断，工具与连接在下一轮任务启动时准备。</p></div>
