...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${sidebar ? 'open' : ''}`}>
      ...
      <div className="sidebar-footer"><div className="runtime-label"><span className={config ? 'connection-dot' : 'offline-dot'} />{config ? `Codex App Server · ${config.codexVersion}` : '正在连接服务'}<span>TS</span></div></div>
    </aside>
